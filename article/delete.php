...
if ($id != "") {
    ...
    if ($data) {
        ...
        $storageBucket->object('thumbnails/' . 'article-' . $id);

        echo '<script>alert("Data delete successfully."); window.location.href = "../view/main.php";</script>';
    } else {
        echo '<script>alert("Article not found."); window.location.href = "../view/main.php";</script>';
    }
} else {
    echo '<script>alert("Invalid article id."); window.location.href = "../view/main.php";</script>';;
}
?>
