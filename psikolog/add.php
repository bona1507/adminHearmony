...
<head>
    ...
    <title>Add Account Psikolog - Hearmony Article Manager</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
    ...
    <form method="post" action="../controller/psikolog_add.php" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" id="profileDescription" name="profileDescription">
            </div>
        </div>
        <div class="form-group row">
